---
title: "transfer.rtp_deposit.failed"
description: "Webhook triggered when an RTP deposit has failed"
openapi: "webhooks-openapi.json webhook transfer.rtp_deposit.failed"
---

Triggered when an RTP deposit has FAILED processing.
