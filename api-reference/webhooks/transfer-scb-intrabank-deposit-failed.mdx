---
title: "transfer.scb_intrabank_deposit.failed"
description: "Webhook triggered when an SCB intrabank deposit has failed"
openapi: "webhooks-openapi.json webhook transfer.scb_intrabank_deposit.failed"
---

Triggered when an SCB intrabank deposit has FAILED processing.
