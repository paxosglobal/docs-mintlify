---
title: "transfer.cubix_deposit.completed"
description: "Webhook triggered when a Cubix deposit has completed"
openapi: "webhooks-openapi.json webhook transfer.cubix_deposit.completed"
---

Triggered when a Cubix deposit has COMPLETED processing.
