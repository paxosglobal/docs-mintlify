---
title: "transfer.rtp_deposit.pending"
description: "Webhook triggered when an RTP deposit has been initiated and is pending"
openapi: "webhooks-openapi.json webhook transfer.rtp_deposit.pending"
---

Triggered when an RTP deposit has been initiated and is PENDING processing.
