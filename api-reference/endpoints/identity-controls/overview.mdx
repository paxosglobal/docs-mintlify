...
Active identity controls are also visible in the `status_details.active_controls` field when retrieving an identity via [GetIdentity](/api-reference/endpoints/identities/get-identity) or [ListIdentities](/api-reference/endpoints/identities/list-identities).
