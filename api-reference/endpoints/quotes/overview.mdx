...
1. Call [List Quotes](list-quotes) to get the latest available
...
3. If a user accepts the price, call [Create Quote Execution](../quote-executions/create-quote-execution) with the amount to buy or sell.
4. Call [Get Quote Execution](../quote-executions/get-quote-execution) to monitor
...
You can call [List Quote Executions](../quote-executions/list-quote-executions) to
