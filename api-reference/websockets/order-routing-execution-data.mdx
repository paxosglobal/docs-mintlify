...
Market availability depends on your Order Routing platform configuration. Common markets include:
- BTCUSD
- ETHUSD
- LTCUSD
- BCHUSD

> Contact [Support](https://support.paxos.com) to verify available markets for your account.