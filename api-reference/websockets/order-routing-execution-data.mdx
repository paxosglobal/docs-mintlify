...
- Executions are not delivered in execution order as they are processed in order isolation. 
  - Individual orders executions will be sent sequentially in the order they were received.
