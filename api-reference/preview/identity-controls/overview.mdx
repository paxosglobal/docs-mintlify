...
## Control Ownership
Controls created via `CreateIdentityControl` create will be `managed_by:CLIENT` and you'll be able to delete these controls.
...
| Managed By | Can Delete | Description |
| --- | --- | --- |
| `CLIENT` | ✓ | Controls managed by your integration |
