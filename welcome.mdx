---
title: "Welcome to Raft"
description: "Learn how to get started with the Raft API and Platform."
mode: "custom"
---
...
<span className="text-gray-900 dark:text-white" style={{fontWeight:"300"}}>Welcome to</span>{' '}<span style={{ fontWeight:"900",background:"linear-gradient(135deg, #64AB28 0%, #51A749 19%, #0094D8 100%)",backgroundClip:"text",WebkitBackgroundClip:"text",color:"transparent",WebkitTextFillColor:"transparent",display:"inline-block" }}>Raft</span>
</h1>
