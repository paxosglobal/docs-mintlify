...
<div style={{
  ...
  <h1 style={{
    ...
    <span style={{
      fontWeight: '900',
      background: 'linear-gradient(135deg, #00845E 0%, #0094D8 50%, #8AD137 100%)',
      backgroundClip: 'text',
  ...
  <CardGroup cols={2}>
    ...
    <Card
      title="Release Notes"
      icon="star"
      href="https://docs.paxos.com/changelog/"
    >
