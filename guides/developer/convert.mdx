...
[asset]: /guides/developer/convert.mdx#assets
[convert]: /api-reference/stablecoin-conversion/create-stablecoin-conversion
[list]: /api-reference/stablecoin-conversion/list-stablecoin-conversions
[get]: /api-reference/stablecoin-conversion/get-stablecoin-conversion
[usdg]: stablecoin/usdg/index.mdx
[usdp]: stablecoin/usdp/index.mdx
[pyusd]: stablecoin/pyusd/index.mdx
[cancel]: /api-reference/stablecoin-conversion/operation/CancelStablecoinConversion
[support]: https://support.paxos.com
[client]: /guides/developer/credentials.mdx
[token]: /guides/developer/authenticate.mdx
[conversion-list-conversion]: /api-reference/stablecoin-conversion/list-stablecoin-conversions
[create-sandbox-deposit]: /api-reference/sandbox/create-sandbox-deposit
[First API Request]: /guides/developer/request.mdx
[conversion-create-conversion]: /api-reference/stablecoin-conversion/create-stablecoin-conversion
[3p-integrations]: /crypto-brokerage/ledger-type.mdx#fiat-and-crypto-subledger
[conversion status]: /guides/developer/convert.mdx#statuses
[fiat-transfers]: /guides/developer/fiat-transfers/quickstart.mdx#funding
...
> If you don't see all the scopes when [creating or editing API credentials](/developer/credentials), contact [Support](https://support.paxos.com).
