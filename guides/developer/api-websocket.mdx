...
[quickstart]: /guides/crypto-brokerage/websocket
[market-data]: api/websocket#market-data-feed
[execution-data]: api/websocket#execution-data-feed
[market-data-path-parameter]: api/websocket#market-data-path-parameter
[execution-data-path-parameter]: api/websocket#execution-data-path-parameter
[available-markets]: api/websocket#available-markets
...
[rate-limits]: /guides/developer/rate-limits#websocket-limits
[v2-api]: api/v2
[payments-guide]: /guides/payments/websocket
