...
| --- | --- | --- |
| `market` | No | Filter the data stream for a single market. For example, `BTCUSD` or another market from [available markets](/api-reference/websockets/overview#available-markets). |

### Execution Data Response

| Parameter | Required | Description|
| --- | --- | --- |
| `market` | Yes | One of the [available markets](/api-reference/websockets/overview#available-markets) or the single market if the `market` [path parameter](/api-reference/websockets/overview#execution-data-path-parameter) is specified. |
...
| `market` | Yes | One of the [available markets](/api-reference/websockets/overview#available-markets) or a single market if the `market` [path parameter](/api-reference/websockets/overview#market-data-path-parameter) is specified. |
...
| `market` | Yes | One of the [available markets](/api-reference/websockets/overview#available-markets) or the single market if the `market` [path parameter](/api-reference/websockets/overview#market-data-path-parameter) is specified. |
