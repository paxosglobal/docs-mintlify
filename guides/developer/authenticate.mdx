...
For example, the following scopes (space delimited) should provide sufficient permissions to [mint](/guides/developer/mint), [redeem](/guides/developer/redeem), and [convert](/guides/developer/convert) Paxos-issued stablecoins:
