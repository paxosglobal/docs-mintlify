...
> If you've already authenticated and have a USD balance in a Profile, skip ahead to the [convert](#mint-hold) or [convert and transfer](#mint-transfer) step.
...
You can create a recurring request that looks for completed transactions in the Profile.
