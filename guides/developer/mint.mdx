...
[stablecoins]: blockchains.mdx#stablecoins
[CreateFiatDepositInstructions]: /api-reference/fiat-transfers/create-fiat-deposit-instructions
[fiat-transfers]: /api-reference/fiat-transfers
[conversion]: /api-reference/stablecoin-conversion/create-stablecoin-conversion
[withdrawal]: /api-reference/crypto-withdrawals/create-crypto-withdrawal
...
[convert stablecoin]: /guides/developer/convert.mdx
[List Profile Balances]: /api-reference/profiles/list-profile-balances
[`SETTLED`]: /guides/developer/convert.mdx#stablecoin-conversion-statuses
