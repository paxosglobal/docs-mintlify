...
To create an account you will need an email address, the business name and country of incorporation, as well as a way to create a [passkey] using a [compatible device](https://www.passkeys.io/compatible-devices).
