...
Orchestrations enable you to automatically convert incoming USD deposits into stablecoins. This powerful feature enables seamless fiat-to-crypto conversions through rule-based orchestrations that trigger upon receiving bank transfers.

## Mint Flow Options

The following diagram shows the two primary mint flows available:
...
Create a rule that automatically converts USD deposits to USDG and sends to an external address:
