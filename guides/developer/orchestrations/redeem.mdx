...
- Sign up to the [Paxos Dashboard](https://docs.paxos.com/guides/dashboard/account) in Sandbox
- Reach out to [Support](https://support.paxos.com/) to provision access to the [Identity API](https://docs.paxos.com/api-reference/endpoints/identity)
- Confirm that you've spoken to Cameron
