...
[identity-api]: /api/v2#tag/Identity
...
[Account]: /api/v2#tag/Accounts
[Add Account Members]: /api/v2#tag/Account-Members/operation/AddAccountMembers
[Remove Account Members]: /api/v2#tag/Account-Members/operation/DeleteAccountMember
[account-api]: /api/v2#tag/Accounts

[Profile]: /api/v2#tag/Profiles
...
<Image src="/img/identity-guide-fund-account-button.png" width="50%" alt="Fund button in Dashboard"/>

Then select the [Profile] related to the [Account] created and fund for $10,000 USD
<Image src="/img/identity-guide-fund-account.png" width="100%" alt="Funding the Account"/>
