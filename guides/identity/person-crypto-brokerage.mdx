...
[edd-guide]: /guides/identity/edd
[Get Identity]: /api-reference/identity/get-identity
[Identity]: /api-reference/identity
[identity-api]: /api-reference/identity
[identity-required-details]: /guides/identity/required-details#required-person-details
[identity-onboarding-decision]: /guides/identity/statuses#onboarding-decision
[identity-status]: /guides/identity/statuses
...
[fiat-transfers-quickstart]: /guides/developer/fiat-transfers/quickstart
...
![Fund button in Dashboard](/img/identity-guide-fund-account-button.png)

Then select the [Profile] related to the [Account] created and fund for $10,000 USD
![Funding the Account](/img/identity-guide-fund-account.png)
