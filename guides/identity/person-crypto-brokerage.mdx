...
<Tip>
 ...
 - If the [Identity] is stuck in `PENDING`, read the [Identity Status](/identity/statuses) guide to help pinpoint why. If you have further questions, you can reach out to [Support][support].
