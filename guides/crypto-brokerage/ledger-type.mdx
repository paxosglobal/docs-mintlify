...
The table below outlines how to populate various fields for the Ledgering Strategies defined above. For more details please see our API reference Documentation for [Orders](/endpoints/orders/create-order), [Transfers](/endpoints/crypto-withdrawals/create-crypto-withdrawal) and [Quotes](/endpoints/quote-executions/create-quote-execution).
