...
[contact-support]: https://support.paxos.com
[create-order]: ../api-reference/endpoints/orders/create-order
[list-executions]: ../api-reference/endpoints/orders/list-executions
[list-orders]: ../api-reference/endpoints/orders/list-orders
[get-order]: ../api-reference/endpoints/orders/get-order
[get-ticker]: ../api-reference/endpoints/market-data/get-ticker
[get-order-book]: ../api-reference/endpoints/market-data/get-order-book
[list-historical-prices]: ../api-reference/endpoints/pricing/list-historical-prices
...
For information on other markets, [contact support][contact-support].
</Tip>
...
- For a comprehensive look at order constraints, please refer to our the documentation for the [Paxos v2 REST API docs][v2-api] or the [Paxos FIX API Reference page][fix-api]
...
- `quote_amount` tick size of 0.01 (1e-2) for [Create Order][create-order].
- `volume_weighted_average_price` tick size of 0.00000001 (1e-8) for [Get Order][get-order] and [List Orders][list-orders].
- `average_price` precision of 0.000001 (1e-6) for [List Historical Prices][list-historical-prices].
- `commission ` and `rebate` tick size of 0.0000000000000000001 (1e-19) for [List Executions][list-executions].
- `gross_trade_amount` tick size of 0.00000000000001 (1e-14) for [List Executions][list-executions].
- `amount` precision of 0.00000001 (1e-8) for [Get Ticker][get-ticker], [Get Order Book][get-order-book] and [List Executions][list-executions].
- `base_amount` precision of 0.00000001 (1e-8) for [List Orders][list-orders], [Create Order][create-order] and [Get Order][get-order].
- `amount_filled` precision of 0.00000001 (1e-8) for [List Orders][list-orders], [Create Order][create-order] and [Get Order][get-order].
...
This provides the volume-weighted average price across all underlying executions for an order within [List Executions][list-executions].
