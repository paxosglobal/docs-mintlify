...
Learn more about [FIX Best Practices](/fix/best-practices), including how to use multiple connections and managing sequence number resets.
...
Once complete, [test](/fix/certify) your connection to our servers.
...
- Test the FIX implementation in the Sandbox environment by running through the [certification process](/fix/certify).
