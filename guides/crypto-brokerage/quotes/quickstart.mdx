...
- Ensure you have a profile set up in Sandbox for trading. You can use the [Sandbox Deposits](/endpoints/sandbox-deposits)
...
The [List Quotes](/endpoints/quotes/list-quotes) service will return a quote for the chosen asset that will be guaranteed for 30 seconds.
...
Crypto Brokerage Partners should use multiplexing and call [List Quotes](/endpoints/quotes/list-quotes) via an application rather than
...
The [Create Quote Execution](/endpoints/quote-executions/create-quote-execution) endpoint is used to execute on a quote for buying or selling an asset.
...
[Get Quote Execution](/endpoints/quote-executions/get-quote-execution) and [List Quote Executions](/endpoints/quote-executions/list-quote-executions) endpoints.
