...
### curl
<Snippet file="_code-samples/_curl/_oauth" />

### python
<Snippet file="_code-samples/_python/_oauth" />

#### Step 1.2: List quotes for BTC and ETH.
### curl
<Snippet file="_code-samples/_curl/_v2-api/_trading/_quotes/_GET-list-quotes" />

### python
<Snippet file="_code-samples/_python/_v2-api/_trading/_quotes/_GET-list-quotes" />
...
### curl
<Snippet file="_code-samples/_curl/_v2-api/_trading/_quote-executions/_POST-create-quote-execution" />

### python
<Snippet file="_code-samples/_python/_v2-api/_trading/_quote-executions/_POST-create-quote-execution" />
...
### curl
<Snippet file="_code-samples/_curl/_v2-api/_trading/_quote-executions/_GET-get-quote-execution" />

### python
<Snippet file="_code-samples/_python/_v2-api/_trading/_quote-executions/_GET-get-quote-execution" />
