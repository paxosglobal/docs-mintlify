...
1. To [use stablecoins for pay-ins](/guides/payments/quickstart#receive-payment), share the crypto deposit address with Buyers as a checkout option.<PaymentsConnectorTip />
