...
[pay-in-add-deposit-address]: payments/quickstart.mdx#pay-in-add-deposit-address
[create-deposit-address]: /api-reference/deposit-addresses/create-deposit-address
[supported-stablecoins]: payments/faq.mdx#supported-assets
[supported-tokens]: payments/faq.mdx#supported-assets
[configuring a stablecoin pay-in workflow]: payments/quickstart.mdx#payment-workflow
[setting up a refund workflow]: payments/quickstart.mdx#refunds
...
[fiat-transfer-guide]: developer/fiat-transfers/index.mdx
[create a fiat account]: /api-reference/fiat-transfers/create-fiat-account
...
[Create Sandbox Deposit]: /api-reference/sandbox-deposits/create-sandbox-deposit
...
Each **Client ID** has a specific set of allowed scopes to access API endpoints.<PaymentsGetKeys />
