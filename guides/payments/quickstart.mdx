...
Learn more about [user onboarding requirements](/guides/payments/faq#seller-onboarding).<PaymentsCreateProfile />
...
To process stablecoin refunds on the Paxos Platform, first [fund your account with USD](/guides/payments/quickstart#refund-fund-account) then use  [Create Crypto Withdrawal] to initiate a stablecoin refund to the Buyer.
