...
Once your webhook is successfully created and shows an Active status in Dashboard, use the Test feature to send test events to your endpoint. Verify that your consumer receives and processes the events correctly.
