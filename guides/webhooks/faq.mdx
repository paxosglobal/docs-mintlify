...
Yes, webhook invocations to your consumer endpoint are rate-limited to 10 per second by default. If you need higher throughput, please contact [Support] to discuss increasing your rate limits. For more information, see our [rate limits documentation](/guides/webhooks/retries-and-limits#rate-limits).
