...
If your consumer failed to process a message, Paxos will attempt to retry for up to 24 hours, read the full [retry policy](/webhooks/retries-and-limits#retry-policy) for more information.
...
Yes, webhook invocations to your consumer endpoint are rate-limited to 10 per second by default. If you need higher throughput, please contact [Support] to discuss increasing your rate limits. For more information, see our [rate limits documentation](/webhooks/retries-and-limits#rate-limits).
