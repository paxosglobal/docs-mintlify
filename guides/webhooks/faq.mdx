...
4. Optionally, trigger real events by using the [CreateIdentity](/api-reference/endpoints/identity/create-identity) API to create a new identity and receive an `identity.approved` event

For more details, see the [Get Started with Webhooks](/guides/webhooks/quickstart) guide.
