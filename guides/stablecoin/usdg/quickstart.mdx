...
1. Create a Paxos Institutional Account
   - Visit [dashboard.paxos.com](https://dashboard.paxos.com/) ([How to sign up](/dashboard/account))
   - Click **"Become a partner of the Global Dollar Network"**
   - Complete the onboarding process
1. **Submit Required Documentation** ([Onboarding requirements](/dashboard/onboard))
