...
You can fund your Sandbox Account with the supported [assets] or those listed in [Create Sandbox Deposit](/api-reference/endpoints/sandbox-deposits/create-sandbox-deposit).
