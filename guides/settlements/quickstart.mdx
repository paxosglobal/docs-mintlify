...
The transaction [status](/guides/settlements/status) can be used used by either party to [retrieve a list of filtered transactions](/guides/settlements/status#list-transactions).
