...
[settle-faq]: settlements/faq.mdx
...
[fund]: #fund
[propose]: #propose
[profile-balances]: /api-reference/profiles/list-profile-balances
[get-profile-balance]: /api-reference/profiles/get-profile-balance
[approve]: #approve 
[get-transaction]: /api-reference/settlement/get-transaction
[set-up-profiles]: #set-up-profiles
[create-transaction]: /api-reference/settlement/create-transaction
[list-transactions]: /api-reference/settlement/list-transactions
[cancel-transaction]: /api-reference/settlement/cancel-transaction
[status]: status.mdx
[faq-assets]: faq.mdx#assets
[affirm]: /api-reference/settlement/affirm-transaction
[authenticate]: #authenticate
[status-list-transactions]: status.mdx#list-transactions
