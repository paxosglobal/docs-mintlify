...
Go to the [Dashboard](https://dashboard.paxos.com/) and click **Transfer** in the top-right corner to send an asset to an external destination or to another [Profile](/dashboard/organization#profile) within the same [Entity](/dashboard/organization#entity).
...
1. Choose a saved address or fiat account where the asset will be _transferred to_ (the destination).<br />Optional: [Create a new network address](/dashboard/addresses#new-address) or [add a fiat account](/dashboard/fiat).
...
Ensure the destination [Profile](/dashboard/organization#profile) already exists before beginning the transfer.
