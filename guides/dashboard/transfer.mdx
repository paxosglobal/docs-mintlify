...
1. Choose a saved address or fiat account where the asset will be _transferred to_ (the destination).<br />Optional: [Create a new network address](/guides/dashboard/withdrawal-addresses) or [add a fiat account](/guides/dashboard/fiat).
