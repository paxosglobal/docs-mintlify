...
[org]: dashboard/organization.mdx#organization
[entity]: dashboard/organization.mdx#entity

Paxos collects certain business and personally identifying information (see below) to ensure your [Organization][org] complies with all regulations and requirements for the jurisdictions your business operates in.
To start using the Paxos platform, onboard an [Entity][entity], which is typically mapped to teams, business groups, holding companies, or separate legal entities.
