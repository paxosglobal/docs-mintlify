...
Before you can complete onboarding, provide Paxos with [supporting documents](/guides/dashboard/onboard#1-gather-supporting-documents) for your organization.
You an upload the documents in the web application. Paxos may reach out to you for additional documentation as needed.
