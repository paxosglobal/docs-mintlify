...
[beneficiary]: dashboard/travel-rule.mdx
[transferring]: dashboard/transfer.mdx
[external-wallet]: dashboard/transfer.mdx#transfer-to-an-external-wallet-or-bank-account
