...
import AddCryptoAddress from "/snippets/add-crypto-address.mdx";
import Permissions from "/snippets/permissions.mdx";

![Add Crypto Address](/images/address-withdrawal.png)
...
Use Addresses to access saved crypto deposit instructions.
...
To download deposit instructions, select the **Actions** menu and use **Export Instructions**.
