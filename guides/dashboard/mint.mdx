...
## **What You'll Do**
1. [Add a destination wallet address](/dashboard/mint#withdraw-address) (This is where you'll receive the stablecoin).
2. [Create minting instructions](/dashboard/mint#minting-instructions), which define:
...
3. [Send USD to the Paxos platform](/dashboard/mint#send-usd) using the generated deposit details.
