...
This avoids potential mistakes around incorrect information and adds an extra layer of security. **Only approved addresses** can be used in any mint process. Similarly deposit instructions **aren't active until approved**.  
