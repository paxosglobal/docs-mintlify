...
<Frame caption="Watch a demo: See the full minting flow from start to finish before getting started.">
...
![Minting Add Address](/images/address-withdrawal.png)
...
Use the [**Approvals**](https://docs.paxos.com/dashboard/admin/approvals) functionality to require additional team members to review any new addresses and instructions before they are saved.
This avoids potential mistakes around incorrect information and adds an extra layer of security. **Only approved addresses** can be used in any mint process. Similarly minting instructions **aren't active until approved**.
...
<Info>
Minting instructions are reusable and immutable. Access [Saved Instructions](dashboard/saved-instructions) to reuse them anytime you want to mint the same asset.

Minting instructions are reusable and immutable. Access [Addresses](https://dashboard.paxos.com/dashboard/addresses/deposit) for crypto or [Fiat Accounts](https://dashboard.paxos.com/dashboard/fiat/deposits) for USD to reuse them anytime you want to mint the same asset.
