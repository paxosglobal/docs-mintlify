...
* [Deposit USD](https://docs.paxos.com/dashboard/deposit), then perform a manual [convert](/guides/dashboard/convert)(https://docs.paxos.com/dashboard/convert) followed by a [manual transfer](https://docs.paxos.com/dashboard/transfer).  
* Use **Convert** to deposit USD and [convert](/guides/dashboard/convert)(https://docs.paxos.com/dashboard/convert) it to a stablecoin, keeping it on-platform in the Profile of your choice, followed by a [manual transfer](https://docs.paxos.com/dashboard/transfer).

<Tip>

Can't find the right minting options? The desired option may not be supported by the [Entity](/guides/dashboard/organization#entities)(https://docs.paxos.com/dashboard/organization#entities) or by the Paxos platform. Reach out to your [Entity Manager](https://docs.paxos.com/dashboard/roles#entity-manager) or [contact us](https://support.paxos.com/hc/en-us/requests/new) for help.
