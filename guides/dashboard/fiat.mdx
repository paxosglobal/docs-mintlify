...
1. Save the fiat account. Optional: Perform a test [deposit](/guides/dashboard/deposit) or [withdrawal](/guides/dashboard/transfer).

## Deposit Instructions

![Fiat Deposit Instructions](/images/fiat-deposit-instructions.png)

Use the **Deposit Instructions** tab to access saved fiat deposit instructions. To download deposit instructions, select the **Actions** menu and use **Export Instructions**.
