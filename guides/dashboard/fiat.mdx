...
Go to [Fiat Accounts](https://dashboard.paxos.com/dashboard/fiat-accounts) to view banking information used to [deposit](/guides/dashboard/deposit) and [withdraw](/guides/dashboard/withdraw) USD on and off the Paxos platform.
...
1. Save the fiat account. Optional: Perform a test [deposit](/guides/dashboard/deposit) or [withdrawal](/guides/dashboard/withdraw).
