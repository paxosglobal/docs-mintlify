...
Go to [Fiat Accounts](https://dashboard.paxos.com/dashboard/fiat-accounts) to view banking information used to [deposit] and [withdraw (transfer)](/dashboard/transfer) USD on and off the Paxos platform.
...
1. Save the fiat account. Optional: Perform a test [deposit] or [withdrawal](/dashboard/transfer).
