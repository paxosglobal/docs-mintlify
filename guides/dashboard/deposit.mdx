...
1. Choose the [Profile](/dashboard/organization#profile) where the assets will be deposited on the Paxos platform.<br />Optional: Save the deposit instructions to make them available for future use an on [Saved Instructions](https://dashboard.paxos.com/dashboard/saved-instructions).
