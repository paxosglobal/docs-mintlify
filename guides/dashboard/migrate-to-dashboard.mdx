...
The [Dashboard](https://dashboard.paxos.com) comes with more self-serviceability, [convert](/guides/dashboard/convert) and [automate](/guides/dashboard/automate) flows for stablecoins, the ability to collaborate with more users from your organization, and [enterprise-grade access controls](/guides/dashboard/admin/team).
