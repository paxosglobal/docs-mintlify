...
Navigate to the [Webhooks](https://dashboard.paxos.com/dashboard/webhooks) section under the Developer tab to view all configured webhooks for your account.
...
- **Rate Limit**: Configured requests per second
- **Event Types**: Number of subscribed event types

Use the **Actions** menu to test, edit, or delete an existing webhook.
