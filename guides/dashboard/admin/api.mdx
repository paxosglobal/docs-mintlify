...
> To add or modify API Credentials, you'll need a [Developer](/dashboard/roles#developer) or other role with appropriate permissions. Contact your [Entity Manager](/dashboard/roles#entity-manager) for help.
...
1. Select the **Scopes** for your **Client ID**. For example, the following scopes (space delimited) should be adequate to [mint](/guides/developer/mint), [redeem](/guides/developer/redeem) and [convert](/guides/developer/convert) Paxos-issued stablecoins:<br/><br/><Scopes />
