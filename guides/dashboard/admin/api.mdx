...
[api-management]: https://dashboard.paxos.com/admin/api
...
Once the credentials are activated, most users find success using one of the libraries on the [OAuth2 website][oauth2] for authentication.
...
1. Log in to your Dashboard account and go to [API Management][api-management].
1. Click **API Credentials**.
1. Create a **Label** for your API credentials.
1. Select the **Scopes** for your **Client ID**. For example, the following scopes (space delimited) should be adequate to [mint], [redeem] and [convert] Paxos-issued stablecoins:<br/><br/><Scopes />
