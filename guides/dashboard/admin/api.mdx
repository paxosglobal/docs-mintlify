...
1. Select the **Scopes** for your **Client ID**. For example, the following scopes (space delimited) should be adequate to [convert](/guides/dashboard/convert) Paxos-issued stablecoins:
