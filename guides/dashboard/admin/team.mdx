...
<video
 controls width="95%" style={{ display:'block', marginLeft: 'auto', marginRight: 'auto' }}>
  <source src="/images/manage-team-invite-users.mp4" type="video/mp4" />
</video>
</Info>
...
2. **Leave the other Organization**:
   ...
   - Click **Organization details** in the top left corner
   - Click the User icon in the top right corner
   - Select **Leave Organization** from the dropdown menu
...
<video
 controls width="95%" style={{ display:'block', marginLeft: 'auto', marginRight: 'auto' }}>
  <source src="/images/manage-team-mapping.mp4" type="video/mp4" />
</video>
</Info>
