...
Approval tiers let you require more approvers for higher-value transactions. Instead of a flat approval count for all amounts, you define USD thresholds where the number of required approvers increases.
...
Other operations only support a flat approver count.
