...
Approval tiers let you require more approvers for higher-value transactions. Instead of a single approver count for all amounts, you define USD thresholds where the number of required approvers increases.
...
Other operations support only a single approver count for all transaction amounts.
...
- **Multiple matching tiers**: The highest matching tier always wins
