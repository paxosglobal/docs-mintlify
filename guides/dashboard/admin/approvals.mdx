...
You can edit individual approval policies to configure the number of approvers required for a specific action. Policy modifications are managed from [Admin > Approval Controls](https://dashboard.paxos.com/admin/approval-controls), the same location used for enabling or disabling policies.
