...
<video controls className="w-full rounded-xl">
 <source src="/images/approvals-demo.mp4" type="video/mp4" />
</video>
...
- Creating [fiat withdrawals](/guides/dashboard/transfer) — supports [approval tiers](/guides/dashboard/admin/approval-tiers)
- Creating [crypto withdrawals](/guides/dashboard/transfer) — supports [approval tiers](/guides/dashboard/admin/approval-tiers)
...
- Adding or deleting conversion instructions in [Addresses](/guides/dashboard/addresses) or [Fiat Accounts](/guides/dashboard/fiat) (mints & redeems to external destinations)
- Adding or deleting [webhooks](/guides/dashboard/webhooks)
- [Cross entity transfer](/guides/dashboard/transfer#cross-entity-transfer)
