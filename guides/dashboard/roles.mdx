...
Paxos offers a flexible access management system that allows you to customize the level at which you control access to various Dashboard actions. 

Users looking for basic functionality have access to pre-defined Paxos Managed roles made up of a set of permissions. For more flexibility, create your own Custom Roles to combine permissions into new roles with more granular modifications. 
...
Custom roles enable organizations to define granular access permissions for users by specifying a tailored set of scopes and actions beyond the above predefined role templates. Entity Managers can assign custom roles to individual users based on operational or compliance requirements. To get started with Custom Roles, click on the "Add Custom Role" button on the [Roles](https://dashboard.paxos.com/admin/team-management/roles/ebc94ddf-cb90-4764-9c7a-eda061b0b5b2) page