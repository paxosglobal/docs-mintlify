...
To access the Dashboard, your [Entity Manager](/dashboard/roles#entity-manager) will either email you an invite to register for a [passkey-based sign in](#passkey) or integrate the Dashboard into your company's [Single Sign-On (SSO)](#sso) solution.

<Tip>

 Having trouble signing in? Don't know what method to use?

Contact your [Entity Manager](/dashboard/roles#entity-manager) or IT organization for help.

</Tip>

## First Time Sign In with Passkey

If you have been invited to join an Organization by an [Entity Manager](/dashboard/roles#entity-manager) for an existing [Entity](/dashboard/organization#entity), use the link provided in your invite email to join your Organization's Dashboard account.
Learn more in the [passkeys guide](/dashboard/passkeys).
