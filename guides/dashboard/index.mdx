...
<CardGroup cols={2}>
  ...
  <Card title="Role-Based Access Control" href="/guides/dashboard/roles" icon="gear">
   ...
   <Card title="Migrate to the Dashboard" href="/guides/dashboard/migrate-to-dashboard" icon="wallet">
    Switch to the Dashboard and access new features and improved workflows.
  </Card>
    <Card title="FAQ" href="/guides/payments/faq" icon="circle-question">
