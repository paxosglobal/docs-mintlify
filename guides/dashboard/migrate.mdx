...
The Paxos Dashboard comes with more self-serviceability, new stablecoin orchestration [mint](/guides/dashboard/mint), [convert](/guides/dashboard/convert) and [redeem](/guides/dashboard/redeem) flows, the ability to [collaborate](/guides/dashboard/admin/team) with more users from your organization, and [enterprise-grade access controls](/guides/dashboard/admin/team). 

> The Dashboard is available to all existing **institutional** account holders. Individual account holders continue to use the [Wallet UI](https://account.paxos.com/).
...
When prompted to create a new [Organization](/guides/dashboard/organization/#organization), provide your Institution information and click **Finish**.
...
Paxos will use this information to create separate [entities](/guides/dashboard/organization/#entity) as needed.
