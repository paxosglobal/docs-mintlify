...
Redemption options may vary based on your account or [Entity](/dashboard/organization#entities) configuration. Reach out to your [Entity Manager](/dashboard/roles#entity-manager) or [contact us](https://support.paxos.com/hc/en-us/requests/new) for support.
