...
<Tip>
Use the [Approvals](https://docs.paxos.com/dashboard/admin/approvals) functionality to require additional team members to review any new fiat accounts or instructions before they are saved. This avoids potential mistakes around incorrect information and adds an extra layer of security. **Only approved fiat accounts** can be used in the redemption process. Similarly redemption instructions **aren't active until approved**.  
</Tip>
