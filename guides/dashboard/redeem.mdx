...
Only users with the **Treasurer** role can redeem stablecoins. [View all roles and permissions](/guides/dashboard/roles). 
...
Redemption options may vary based on your account or [Entity] configuration. Reach out to your [Entity Manager](/guides/dashboard/roles#entity-manager) or [contact us](https://support.paxos.com/hc/en-us/requests/new) for support.
