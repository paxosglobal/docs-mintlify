...
[Entities](/guides/dashboard/organization#entity) onboarded to certain geographies must adhere to [Travel Rule](https://notabene.id/crypto-travel-rule-101/what-is-the-crypto-travel-rule) checks when depositing and withdrawing crypto to and from the Paxos platform.

The Crypto Travel Rule requires virtual asset service providers (VASPs) like banks, exchanges, custodial solutions, and financial services providers to identify and share details of the origin and destination of crypto transactions above a specific threshold.
...
Crypto withdrawals can only be made to [saved addresses](/guides/dashboard/withdrawal-addresses) that include beneficiary details.
