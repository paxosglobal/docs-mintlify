...
To add a new destination wallet address, go to [Addresses](https://dashboard.paxos.com/dashboard/addresses) and use <ButtonAdd label="⊕︎ Address" /> to get started.
