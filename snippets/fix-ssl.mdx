...
```
Most FIX users can use [stunnel](https://www.stunnel.org/) to add encryption functionality to the client.
[stunnel](https://www.stunnel.org/) is suitable for large deployments and does not require client code changes.
### Sandbox
