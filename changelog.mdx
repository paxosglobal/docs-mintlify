...
<Update label="December 1, 2025" description="Dashboard">
    **Configurable Approvers**: You can now modify approval policies from the Dashboard. Navigate to **Admin > Approvals** to edit existing approval policy configurations. See the [Dashboard Approvals guide](/guides/dashboard/admin/approvals) for more information.
</Update>
