...
rss: true
---
<Update label="January 16, 2025" description="v2 API">
    **V2 API**: Renamed `summary_status` to `status` in Identity API responses. The `status` field now provides the identity verification status across all Identity API endpoints.
</Update>
