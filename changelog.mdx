...
rss: true
---
<Update label="November 6, 2025" description="v2 API">
    **v2 API**: Add value `DOTFILE` to parameter `person_details.passthrough_verifier_type` on Create Identity and Update Identity request and response.
</Update>
