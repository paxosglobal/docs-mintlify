...
**Identity Controls API**: Added new [Identity Controls API](/api-reference/endpoints/identity-controls/overview) for managing identity lifecycle states. Control types include `SELL_ONLY`, `CLOSED`, `FROZEN`, and `DORMANT`. See the [Dormancy Lifecycle guide](/guides/identity/dormancy) for managing inactive identities.
</Update>
