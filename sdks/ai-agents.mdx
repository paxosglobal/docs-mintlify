...
- [`/llms.txt`](/llms.txt) — Structured index of all documentation pages, following the [llmstxt.org](https://llmstxt.org) convention
- [`/llms-full.txt`](/llms-full.txt) — Complete documentation compiled into a single file for full-context AI prompts
